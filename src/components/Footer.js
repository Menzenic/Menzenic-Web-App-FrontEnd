        ...
        <div className="left-section flex flex-col pl-6">
          <div className="left-section-top flex justify-between my-10">
            <div className="footer-section mr-20">
              ...
              <p className="footer-para text-left">2972 Westheimer Rd.</p>
            ...
            <div className="footer-section">
              ...
              <p className="footer-para text-left">contact@menzenic.com</p>
              <p className="footer-paras text-left my-2">+915654623164</p>
            </div>
          </div>
