	...
	return (
		...
		>
				...
				<div className="flex flex-col pl-0 sm:pl-6">
					<div className="flex flex-col sm:flex-row justify-between my-10">
						<div className="mr-10">
							...
							<p className="text-left">A-23, Sector 16</p>
							<p className="text-left my-2">Noida, India</p>
						</div>
						<div className="mt-8 sm:mt-0">
							<h3 className="font-bold text-left text-2xl mb-4 text-black">
								Contact
							</h3>
							<p className="text-left">admin@menzenic.com</p>
							<p className="text-left my-2">+91 99539-47019</p>
						</div>
					</div>
					{/* <div
			...
			<div className="flex justify-center sm:justify-start mt-8 w-full mx-auto sm:pl-4">
				...
				<a
					href="https://www.instagram.com/menzenic/"
					target="_blank"
					rel="noopener noreferrer"
				>
				...
				<a
					href="https://www.youtube.com/@Menzenic/featured"
					target="_blank"
					rel="noopener noreferrer"
				>
