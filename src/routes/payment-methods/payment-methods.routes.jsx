...
const PaymentMethods = () => {
    return (
        <section>
            <div className="container bg-black mx-auto pt-32 pb-20 px-6">
                <h2 className="text-3xl font-semibold text-white mb-8">
                    Payment Methods
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div className="bg-white shadow-lg rounded-3xl p-6 hover:shadow-white hover:scale-105 transition-all duration-300">
