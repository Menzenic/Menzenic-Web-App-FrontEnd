...
const Billing = () => {
    ...
    return (
        <section>
            <div className="newpage-container p-12 flex label-arial">
                ...
                <div className="billing-right w-[45%] pr-12">
                    <div className="billing-details w-[35.688rem] h-auto rounded bg-white text-black px-10 py-6 leading-10">
                        <h2 className="text-center text-2xl mb-2">
                            Your Order
                        </h2>
                        <div className="w-[30.25rem] h-0.5 mx-auto bg-gray-300"></div>
                        <div className="flex justify-between mt-4 mb-3 px-2">
                            <p>Product</p>
                            <p>Sub Total</p>
                        </div>
                        <div className="w-[30.25rem] h-0.5 mx-auto bg-gray-300"></div>
                        <div className="flex justify-between mt-4 mb-3 px-2">
                            <p className="custom-opacity-51">Product1</p>
                            <p>399</p>
                        </div>
                        <div className="w-[30.25rem] h-px mx-auto bg-gray-300 line-opacity-66 "></div>
                        <div className="flex justify-between mt-4 mb-3  px-2">
                            <p className="custom-opacity-51">Delivery Charge</p>
                            <p>50</p>
                        </div>
                        <div className="w-[30.25rem] h-px mx-auto bg-gray-300 line-opacity-66 "></div>
                        <div className="flex justify-between mt-4 mb-3 px-2">
                            <p className="custom-opacity-51">Subtotal</p>
                            <p>449</p>
                        </div>
                        <div className="w-[30.25rem] h-px mx-auto bg-gray-300 line-opacity-66 "></div>
                        <div className="radio-buttons flex justify-between mt-5 px-2">
                        ...
                        <div className="w-[30.25rem] h-px mx-auto bg-gray-300 line-opacity-66 my-5"></div>
                        <div className="privacy-policy px-2">
                            <p className="text-xs">
                        ...
                        <div className="w-[30.25rem] h-px mx-auto bg-gray-300 line-opacity-66 my-5"></div>
                        <div className="term-condition mb-6">
                            <label
                            ...
                            >
                                ...
                                <span className="text-xs">
                                    ...
                                    and conditions <u>terms and conditions*</u>
                                </span>
                            </label>
                        </div>
